...
Future<void> logDebug(String tag, String message, [Object? error, StackTrace? stackTrace]) {
  return _logger.debug(tag, message, error, stackTrace);
}

Future<void> logInfo(String tag, String message, [Object? error, StackTrace? stackTrace]) {
  return _logger.info(tag, message, error, stackTrace);
}

Future<void> logWarning(String tag, String message, [Object? error, StackTrace? stackTrace]) {
  return _logger.warning(tag, message, error, stackTrace);
}

Future<void> logError(String tag, String message, [Object? error, StackTrace? stackTrace]) {
  return _logger.error(tag, message, error, stackTrace);
}

Future<void> logFatal(String tag, String message, [Object? error, StackTrace? stackTrace]) {
  return _logger.fatal(tag, message, error, stackTrace);
}